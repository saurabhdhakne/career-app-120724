            ...
            <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10 mt-20">
                ...
                <div className="mt-5 max-w-6xl text-center mx-auto">
                    <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl">
                        An Integrated,
                        <span className="bg-clip-text bg-primary-gradient text-transparent"> One-stop solution </span>
                        <br />
                        for every
                        <span className="bg-clip-text bg-primary-gradient text-transparent"> career counselling </span>
                        need
                    </h1>
                </div>
                ...
                <div className="mt-5 max-w-3xl text-center mx-auto">
                    <p className="text-lg text-gray-600">
                        <span className='inline-block'>  Career Guidence & Counselling </span>
                        <span className='font-extrabold mx-2 '> | </span> <span className='inline-block'> Psychometric Assesment </span>
                        <span className='font-extrabold mx-2 '> | </span> <span className='inline-block'> Personalised Reports </span>
                        <span className='font-extrabold mx-2 '> | </span> <span className='inline-block'> Career Demos </span>
                        <span className='font-extrabold mx-2 '> | </span> <span className='inline-block'> Powerful Dashboard & Analytics for School & Institutes </span>
                        <span className='font-extrabold mx-2 '> | </span> <span className='inline-block'> Counseller Training </span>
                    </p>
                </div>

                <div className="mt-8 gap-3 flex justify-center">
                    <a className="inline-flex justify-center items-center gap-x-3 text-center bg-primary-gradient border border-transparent text-white text-sm font-medium rounded-md focus:outline-none focus:ring-1 focus:ring-gray-600 py-3 px-4" href="#">
                        Get started
                        <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6" /></svg>
                    </a>
